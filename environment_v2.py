...
class Environment_v2(object):
    ...
    # Using multi-hot to realize the fixed input size. Dimension of obs is 31. Numbers are normalized
    def get_obs(self):

        # Remaining steps in episode
        step_count_obs = [(self.episode_steps - self.step_count) / self.episode_steps]
