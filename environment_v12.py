...
class Environment_v12(Environment_v11):
    ...
    def get_obs(self):
        ...
        # Channel 6: normalized item-to-target distance
        for item_loc, item_time in zip(self.item_locs, self.item_times):
            ...
            item_target_distance = dist_item_target / self.max_target_distance
            item_target_distance = max(0.0, min(1.0, item_target_distance))

            obs[3, r, c] = 1.0
            obs[4, r, c] = time_left
            obs[5, r, c] = reachability
            obs[6, r, c] = item_target_distance
