...
MODEL_NAME = 'DQN_v11.11.7_variant_0'
MODEL_PATH = f'./models2/{MODEL_NAME}.pt'
VARIANT = 0
DATA_DIR = './data'
NUM_TEST_EPISODES = 100
RESULT_DIR = './test_result'
RESULT_FILE_NAME = 'Test_Results_DQN_v11.11.7_variant_0.csv'
...
if __name__ == '__main__':
    ...
    env = Environment_v11(variant=VARIANT, data_dir=DATA_DIR)  # initialize the environment
