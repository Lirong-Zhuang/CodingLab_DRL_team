...
class Environment_v9h(Environment_v9):
    """Hybrid form of Environment_v9: spatial maps plus two scalars."""
    ...
    def get_obs(self):
        ...
        # Spatial channels: agent, item presence, item time, item value.
        grid_obs = full_obs[[0, 3, 4, 5], :, :].copy()
